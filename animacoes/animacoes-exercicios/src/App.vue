	...
	<div id="app" class="container-fluid">
		...
		<!-- <b-button variant="primary" class="mb-4" @click="exibir = !exibir">Mostrar Mensagem</b-button>
		 ...
		 <transition name="fade">
			<b-alert variant="info" show v-show="exibir" v-text="msg"></b-alert>
		</transition>
	
		<transition name="slide" type="animation" appear>
			<b-alert variant="info" show v-if="exibir" v-text="msg"></b-alert>
		</transition>
		...
		<transition :name="tipoAnimacao" mode="out-in">
			<b-alert variant="info" show v-if="exibir" v-text="msg" key="info"></b-alert>
			<b-alert variant="warning" show v-else v-text="msg" key="warn"></b-alert>
		</transition>
		...
		<transition-group name="slide" tag="div">
			<b-list-group v-for="(aluno, index) in alunos" :key="index">
				<b-list-grupo-item @click="removerAluno(index)">{{ aluno }}</b-list-grupo-item>
			</b-list-group>
		</transition-group>
